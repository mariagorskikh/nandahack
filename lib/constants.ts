...
export const TIMELINE = [
  {
    ...
    endDate: "2026-03-27",
    items: [
      "Hackathon officially announced",
      "Form teams and choose an arena",
      "Start exploring the 5 arenas",
      "Prepare for the buildathon",
    ],
  },
  {
    phase: "Buildathon",
    title: "In-Person Buildathon",
    dates: "Apr 11, 2026",
    startDate: "2026-04-11",
    endDate: "2026-04-11",
    items: [
      "In-person buildathon event",
      "Kick off with fellow builders",
      "Kick off your project with your team",
      "Mentor office hours and support",
  ...
  },
  {
    ...
    endDate: "2026-05-07",
    items: [
      "Continue building after the buildathon",
      "Polish and optimize your solution",
      "Submit code, video demo, and slides",
      "Final submissions due before May 7",
    ],
  },
  {
    phase: "Awards",
    ...
    items: [
      ...
      "Judging: Impact, Technical Depth, Simplicity",
      "Winners announced",
      "Celebration",
    ],
  },
...
export const FAQS = [
  {
    ...
    answer:
      "The Agentic AI Hackathon is an arena-style hackathon where AI agents are battle-tested across six arenas. Instead of building another chatbot, you prove that your agents actually work under pressure.",
  },
  {
    question: "Who can participate?",
    answer:
      "Anyone — solo developers, teams, researchers, students. If you can write code and have ideas about how to fix agent infrastructure, you're welcome. Teams of up to 4 people are recommended.",
  },
  {
    question: "What should I build?",
    answer:
      "Choose an arena — The Forge (deployment), The Commons (coordination), The Bazaar (trading), The Gauntlet (reasoning), The Wall (adversarial defense), or The Throne (full integration) — and build agents that survive the challenge.",
  },
  {
    question: "What does 'compatible with NEST' mean?",
    answer:
      "NEST is the deployment infrastructure. Your solution should be deployable on NEST or integrate with agents running on NEST. We'll provide documentation and support during the hackathon.",
  },
  {
    question: "Do I need to use a specific tech stack?",
    answer:
      "No. Use whatever language, framework, or tools you prefer. The only requirement is that your solution must be deployable and usable by other developers. We do have two tracks — OpenClaw (Codex-based) and Join39 — so pick the one that fits your approach.",
  },
  {
    question: "How are submissions judged?",
    answer:
      "Impact (40%): Does it solve a real problem? Technical Depth (40%): Is the implementation solid? Simplicity (20%): Is it easy to adopt? We value working software over fancy presentations.",
  },
  {
    question: "Is there a submission fee?",
    answer:
      "No. The Agentic AI Hackathon is free to enter. We want the best ideas, not the deepest pockets.",
  },
  {
    question: "Can I submit an existing project?",
    answer:
      "You can build on existing work, but the submission should include meaningful new development done during the hackathon period. We'll check commit history.",
  },
];
